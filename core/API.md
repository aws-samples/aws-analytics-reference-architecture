...
| <code><a href="#aws-analytics-reference-architecture.NotebookUserOptions.property.iamUser">iamUser</a></code> | <code>aws-cdk-lib.aws_iam.IUser</code> | IAM User to for EMR Studio, if both iamUser and identityName are provided, the IAM User will have precedence and will be used for EMR Studio. |
...
IAM User to for EMR Studio, if both iamUser and identityName are provided, the IAM User will have precedence and will be used for EMR Studio.
