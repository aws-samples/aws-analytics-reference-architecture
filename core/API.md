...
##### `tagResource` <a name="aws-analytics-reference-architecture.LakeFormationTag.tagResource" id="awsanalyticsreferencearchitecturelakeformationtagtagresource"></a>
