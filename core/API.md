...
| <code><a href="#aws-analytics-reference-architecture.NotebookPlatformProps.property.userIamPolicy">userIamPolicy</a></code> | <code>@aws-cdk/aws-iam.PolicyDocument</code> | EMR Studio users IAM policy, used only when Amazon EMR Studio authentication mode is SSO if no policy is provided a default policy is applied. |
...
##### `userIamPolicy`<sup>Optional</sup> <a name="userIamPolicy" id="aws-analytics-reference-architecture.NotebookPlatformProps.property.userIamPolicy"></a>

```typescript
public readonly userIamPolicy: PolicyDocument;
```

- *Type:* @aws-cdk/aws-iam.PolicyDocument

EMR Studio users IAM policy, used only when Amazon EMR Studio authentication mode is SSO if no policy is provided a default policy is applied.
...
| <code><a href="#aws-analytics-reference-architecture.NotebookUserOptions.property.userIamPolicy">userIamPolicy</a></code> | <code>@aws-cdk/aws-iam.PolicyDocument</code> | The iam policy to be applied for the user, if no policy is provided a default one would be applied to the user. |
...
##### `userIamPolicy`<sup>Optional</sup> <a name="userIamPolicy" id="aws-analytics-reference-architecture.NotebookUserOptions.property.userIamPolicy"></a>
