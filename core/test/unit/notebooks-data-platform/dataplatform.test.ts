...
dept1.addNotebookPlatform({
  ...
  acmCertificateArn: 'arn:aws:acm:eu-west-1:214783019211:certificate/8a5dceb1-ee9d-',
});
...
dept2.addNotebookPlatform({
  ...
  acmCertificateArn: 'arn:aws:acm:eu-west-1:123456789012:certificate/8a5dceb1-7b4a1ea0b64d',
});
