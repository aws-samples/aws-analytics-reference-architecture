...
class JsonDeserializationSchemaTest {
    ...
    void shouldDeserializeFromJson() throws IOException {
        ...
        final JsonDeserializationSchema<Address> deserializer = new JsonDeserializationSchema<>(Address.class);
        final Address address = deserializer.deserialize(json.getBytes(Charset.defaultCharset()));
